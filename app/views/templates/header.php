        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto mx-auto">
            <li class="nav-item mr-3 active">
              <a class="nav-link" href="<?= BASE; ?>/Guru/index">Home</a>
            </li>
            <li class="nav-item ml-3 mr-3">
              <a class="nav-link" href="<?= BASE; ?>/Guru/register">Data Siswa</a>
            </li>
            <li class="nav-item ml-3 mr-3">
              <a class="nav-link" href="<?= BASE; ?>/Guru/mapelGuru">Mata Pelajaran</a>
            </li>
